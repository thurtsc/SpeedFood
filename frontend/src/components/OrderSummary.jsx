...
const OrderSummary = () => {
	...
	return (
		...
		>
			<p className='text-xl font-semibold text-yellow-400'>Resumo do pedido</p>

			<div className='space-y-4'>
				<div className='space-y-2'>
					<dl className='flex items-center justify-between gap-4'>
						<dt className='text-base font-normal text-gray-300'>Preço</dt>
					...
					{savings > 0 && (
						<dl className='flex items-center justify-between gap-4'>
							...
							<dd className='text-base font-medium text-yellow-400'>-R${formattedSavings}</dd>
						</dl>
					)}
					...
					<dl className='flex items-center justify-between gap-4 border-t border-gray-600 pt-2'>
						...
						<dd className='text-base font-bold text-yellow-400'>R${formattedTotal}</dd>
					</dl>
				</div>
